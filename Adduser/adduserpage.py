...
def loginfr(root,cursor,bgcolour):
    ...
    login_button = Button(root,cursor='hand2', text="Add User", command=lambda: login(cursor,username_entry, password_entry, admin_entry,login_status_label), font=("Arial", 16),bg="light blue")
